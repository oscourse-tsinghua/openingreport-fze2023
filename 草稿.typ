...
区块链客户端支持的操作多种多样，为所有这些操作提供系统调用显然是不现实的。因此，必须确定改良后的rCore将支持哪些区块链操作。#link("https://snakecharmers.ethereum.org/a-developers-guide-to-ethereum-pt-1/")[开发者的以太坊之旅]是一系列指引入门学习者上手以太坊区块链的博客文章，其中清晰地展示并使用了以下以太坊区块链客户端的功能特性：
